...
public class CaldroidGridAdapter extends BaseAdapter {
    ...
    protected DateTime selectedDates;
    ...
    public void setSelectedDates(DateTime selectedDates) {
    ...
    private void populateFromCaldroidData() {
        ...
        selectedDates = (DateTime) caldroidData
                .get(CalendarFragment.SELECTED_DATES);
        if (selectedDates != null) {
            selectedDatesMap.clear();
                selectedDatesMap.put(selectedDates, 1);
        }
        ...
        squareTextViewCell = (Boolean) caldroidData
                .get(CalendarFragment.SQUARE_TEXT_VIEW_CELL);

        // Get theme
        themeResource = (Integer) caldroidData
                .get(CalendarFragment.THEME_RESOURCE);
...
//                bottomPadding);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LayoutInflater localInflater = CalendarFragment.getLayoutInflater(context, inflater, themeResource);
